...
export const updatePackerKitItem = (innhoppId: number, key: string, checked: boolean) =>
...
export const updatePackerReturnKitItem = (innhoppId: number, key: string, checked: boolean) =>
