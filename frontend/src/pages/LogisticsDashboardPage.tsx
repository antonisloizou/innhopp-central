...
const LogisticsDashboardPage = () => {
  ...
  const dateOptions = useMemo(() => {
    ...
    return transports
      ...
      .sort((a, b) => a.localeCompare(b));
  }, [transports, selectedSeason, selectedEvent, selectedVehicle]);
  ...
  }, [transports, selectedSeason, selectedEvent, selectedVehicle, selectedDates, pickupFilter, destinationFilter]);
